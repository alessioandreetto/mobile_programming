...
class _HomeListState extends State<HomeList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            'Benvenuto ' + Provider.of<WalletProvider>(context).name + '!'),
        elevation: 0,
                      ...
                      Expanded(
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Wallet wallet = walletProvider.wallets[index];
                            return Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                          "Nome Wallet: ${selectedWallet.name}"),
                                      Text(
                                  ...
                                  FutureBuilder<List<Transaction>>(
                                    future: _fetchTransactions(wallet.id!),
  ...
  void _handlePieChartTap(
    ...
    setState(() {
      ...
      if (_selectedCategory == tappedCategory) {
        ...
        nomeCategoria =
            categories[int.parse(tappedCategory) % categories.length].name;
